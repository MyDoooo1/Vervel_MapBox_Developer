...
// --柳世钢实现读取文件逻辑与promise操作、解析行政区划、点击边界高亮显示-------
// --其余部分由叶垚森实现-----------------------------------------------
function handleFiles() {
    ...
    promise.then(function (result) {
        ...
        } else if (geometryType === 'line') {     // 导入OSM线
        } else if (geometryType === 'linestring') {     // 导入自定义路线
            // --柳世钢--检查 GeoJSON 数据对象的数量,解析城市道路网
            if (geojsonData.features.length > 100) {
                console.log('数据大于100');
